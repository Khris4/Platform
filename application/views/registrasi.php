				...
				<form action="<?= base_url(); ?>authorization/simpan" method="post">
					...
					<div class="input-group mb-3">
						...
						<div class="gender m-2">
							Jenis Kelamin :<br/>	
							<input class="pria" type="radio" value="Pria" name="jk"/> Pria
							<input class="perempuan" type="radio" value="Perempuan" name="jk"/> Perempuan <br/>
						</div>
						...
						<div class="action d-flex p-2">
							...
							<div>
								<a href="<?= base_url() ?>authorization" type="submit" class="btn btn-secondary"
